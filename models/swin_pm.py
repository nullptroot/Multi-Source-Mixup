...
class PMTrans(nn.Module):
    ...
    def __init__(self, num_classes=65, model_name='swin_base',source_num=1):
        ...
        self.s_dist_alpha = [nn.Parameter(torch.Tensor([1]))]*source_num
        self.s_dist_beta = [nn.Parameter(torch.Tensor([1]))]*source_num

        self.super_ratio = [nn.Parameter(torch.Tensor([-2]))]*source_num
        self.unsuper_ratio = [nn.Parameter(torch.Tensor([-2]))]*source_num
